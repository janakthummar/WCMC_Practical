...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "CSE","IT","CE"};
	private String[] yearString = new String[] {"FIRST","SECOND","THIRD"};
	private String[] subjectSEString = new String[] {"C","ICT"};
	private String[] subjectTEString = new String[] {"C++","DSA"};
	private String[] subjectBEString = new String[] {"CN","DAA"};

	private String[] subjectFinal = new String[] {"C","ICT","C++","DSA","CN","DAA"};
